...
time mvn exec:java -Dexec.mainClass=ConvertJava -Dexec.args="compilationUnit ../../../javaPractice/jsrc.json ../../../javaPractice/"
...
# featurize asts
time python3 src/main/python/similar.py -c ../../../javaPractice/jsrc.json -d ../../../tmpout
